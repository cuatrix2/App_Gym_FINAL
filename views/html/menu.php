...
<style>
    .rounded-circle {
        border-radius: 50%;
        width: 45px; /* Ajusta el tamaño de la imagen según tus necesidades */
        height: 40px;
    }
</style>
...
<li class="nav-item active">
    <a class="nav-link" href="../Information/Information.php">
    <i class="fas fa-fw fa-sticky-note"></i>
        <span>Informacion Nutricional y de Salud</span></a>
</li>
